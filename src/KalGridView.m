...
- (id)initWithFrame:(CGRect)frame logic:(KalLogic *)theLogic delegate:(id <KalViewDelegate>)theDelegate colorSource:(KalColorSource *)source {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        frontMonthView = [[KalMonthView alloc] initWithFrame:monthRect colorSource:colorSource];
        backMonthView = [[KalMonthView alloc] initWithFrame:monthRect colorSource:colorSource];
